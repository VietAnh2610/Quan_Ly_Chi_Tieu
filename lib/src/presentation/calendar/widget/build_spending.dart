import 'package:spending_management/src/presentation/view_spending/screen/view_spending_page.dart';
...
class BuildSpending extends StatelessWidget {
  const BuildSpending({super.key, this.spendingList, this.date, this.change});
