...
import 'package:spending_management/src/data/models/spending.dart';
import 'package:spending_management/src/data/models/user.dart' as myuser;
...
class SummarySpending extends StatefulWidget {
  const SummarySpending({super.key, this.spendingList});
...
class _SummarySpendingState extends State<SummarySpending> {
  ...
  Widget body(var wallet, var sumValue) {
    return Padding(
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    numberFormat.format(wallet + sumValue),
                    style: const TextStyle(fontSize: 18),
                  )
                ],
              ),
              ...
              Row(
                children: [
                  const Spacer(),
                  Text(
                    "${sumValue > 0 ? "+" : ""}${numberFormat.format(sumValue)}",
